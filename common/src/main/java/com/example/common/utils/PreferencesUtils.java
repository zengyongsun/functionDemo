...
public class PreferencesUtils implements PreferencesUtilsI {
	// private static PreferencesUtilsI mPreferenceConfig;
	...
	public static PreferencesUtils getPreferenceConfig(Context context) {
		...
		// {
		// mPreferenceConfig = new PreferencesUtils(context);
		// }
	...
	public void loadConfig(String preFileName){
		this.filename = preFileName;
		loadConfig();
	}
